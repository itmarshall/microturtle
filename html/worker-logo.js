...
var LogoWorker = exports.LogoWorker = function(sender) {
    Mirror.call(this, sender);
    this.setTimeout(200);
};
oop.inherits(LogoWorker, Mirror);

(function() {
 this.onUpdate = function() {
     var value = this.doc.getValue();
     var errors = [];
     var results = logo.verifyProgram(value);

     for (var i = 0; i < results.length; i++) {
         var error = results[i];
         errors.push({
             row: error.line-1, // must be 0 based
             column: error.col-1,  // must be 0 based
